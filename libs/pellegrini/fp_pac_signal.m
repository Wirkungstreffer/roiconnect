...
%interacting bands  % To do: inputs
...
elseif params.case==3 % uni + bivariate case (not published) 
    ...
    if isempty(params.iroi_amplt)
        iroi_amplt = randperm(D.nroi,sum(params.iInt))'; %select regions for both uni and bivariate interactions
